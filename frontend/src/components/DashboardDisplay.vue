    ...
    <div class="container px-4 mx-auto">
      <div class="mb-6">
        <div class="flex flex-wrap -mx-3 -mb-6">
          <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
            <div class="max-w-sm mx-auto py-8 px-6 bg-gray-600 rounded-xl">
      ...
      <div class="mb-6">
        <div class="flex flex-wrap -mx-3">
          <div class="w-full lg:w px-3">
            <div class="h-full p-6 bg-gray-600 rounded-xl">
                ...
                <table class="w-full min-w-max">
                  ...
                  <tbody>
                      ...
                      <td class="p-0">
                        <div class="h-16 p-6">
                          <div class="flex h-full items-center">
                            <img class="w-8 h-8 mr-3 rounded-full object-cover" src="https://lh3.googleusercontent.com/a/ACg8ocINeRXReJUk59msoHTNLbBL3YN2oAnlqq2AjmixQVBcCAnBmVARMg=s96-c" alt="">
                    ...
                    <tr>
                      ...
                      <td class="p-0">
                        <div class="flex h-16 p-6 items-center rounded-r-xl bg-gray-700">
