locals {
  region       = "us-central1"
  project_name = "firebase-planning-poker-dev"
  project_id   = "fire-planning-poker-dev"

  firebase_adminsdk_account = "firebase-adminsdk-8qn3f"
}
...
terraform {
  backend "gcs" {
    bucket = "fire-planning-poker-dev.appspot.com"
    prefix = "tfstate"
  }
}
